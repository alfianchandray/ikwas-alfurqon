/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 7728f139771756ac4f39a967cbea1b9b)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* ikwas-financial */;
}
